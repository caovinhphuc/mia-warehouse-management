...
function doGet(e) {
  return ContentService.createTextOutput(
    JSON.stringify({
      ...
      endpoint: "AKfycbxSt8QUiny3-a_iW_-W50GUteSpERWj1ddma3TMH1y1V5UQfY4bswhVZ1o7Aj3FE_UZ"
    })
  ...
  try {
    ...
    if (!auditSheet) {
      ...
      auditSheet.appendRow([
        "Timestamp", "Action", "Username", "Details", "Status", "IP Address"
      ]);
    }
    ...
    if (requestData.action && (
      ...
      if (!loginSheet) {
        ...
        loginSheet.appendRow([
          "Timestamp", "Action", "Username", "Details", "Status", "IP Address", "Session ID"
        ]);
      }
