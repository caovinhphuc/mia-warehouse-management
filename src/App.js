...
const TransportModule = lazy(() =>
  import('./modules/transport').catch(() => ({
    default: () => <div className="p-4">Error loading Transport module</div>,
  })),
)
...
const ThemeProvider = memo(({ children }) => {
  const [isDarkMode, setIsDarkMode] = useState(() => {
    try {
      ...
      logger.warn('Error reading theme preference:', error)
      return false
    }
  })
      ...
      try {
        ...
        if (isOnline) {
          try {
            ...
            logger.warn('Network latency check failed:', error)
          }
        }
                      ...
                      >
                        ...
                        <Route
                          ...
                          element={
                            <Suspense
                              fallback={
                                <ModuleLoadingFallback moduleName="Integration Dashboard" />
                              }
                            >
                              <DashboardModule />
                            </Suspense>
                        ...
                        <Route
                          ...
                          element={
                            <Suspense
                              fallback={
                                <ModuleLoadingFallback moduleName="Kho bãi & Vận chuyển" />
                              }
                            >
                              <TransportModule />
                            </Suspense>
