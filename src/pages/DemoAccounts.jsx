      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed">
              Hệ thống cung cấp <strong>5 tài khoản demo</strong> với các quyền
              hạn khác nhau để bạn có thể trải nghiệm đầy đủ chức năng của
              dashboard quản lý kho vận.
            </p>
          </div>
          ...
          <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 max-w-2xl mx-auto">
            ...
            <p className="text-blue-600 dark:text-blue-400 mt-2 text-sm">
              ...
              <br />• Có thể đăng nhập bằng cách click "Đăng nhập nhanh" hoặc
              ...
              >
                ...
                <div className="p-6">
                    ...
                    <ul className="space-y-1">
                      ...
                      {account.userData.features.length > 3 && (
                        <li className="text-xs text-gray-500 dark:text-gray-500">
                          +{account.userData.features.length - 3} tính năng
                          khác...
                        </li>
                      )}
                    </ul>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      onClick={() =>
                        copyCredentials(username, account.password)
                      }
            ...
            <div>
              ...
              <ol className="space-y-3 text-gray-600 dark:text-gray-400">
                <li className="flex items-start space-x-3">
                  ...
                  <span>
                    Chọn tài khoản demo phù hợp với vai trò bạn muốn trải nghiệm
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center text-sm font-medium">
                  ...
                  <span>
                    Click "Đăng nhập nhanh" hoặc copy username/password
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center text-sm font-medium">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                <li className="flex items-start space-x-3">
                  ...
                  />
                  <span>
                    <strong>Role-based Access:</strong> Mỗi tài khoản có quyền
                    hạn khác nhau
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  />
                  <span>
                    <strong>Real-time SLA:</strong> Theo dõi P1-P4 priority
                    orders
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  />
                  <span>
                    <strong>Google Sheets Sync:</strong> Tích hợp đồng bộ dữ
                    liệu
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  />
                  <span>
                    <strong>Dark/Light Mode:</strong> Giao diện tối/sáng linh
                    hoạt
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  />
                  <span>
                    <strong>Responsive Design:</strong> Tương thích
                    mobile/tablet
                  </span>
                </li>
              </ul>
        ...
        <div className="mt-12 text-center text-gray-500 dark:text-gray-400">
          ...
          <p className="text-xs mt-1">
            Version 2.1.0 - Demo Environment - Cập nhật: 12/06/2025
          </p>
        </div>
      </div>
    </div>
