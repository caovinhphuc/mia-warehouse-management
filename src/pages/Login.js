  ...
  useEffect(() => {
    const initLogin = async () => {
      try {
        ...
        logger.info("Login system initialization failed:", error);
    ...
    try {
      ...
      if (connectionStatus !== "connected") {
        ...
        try {
          ...
          logger.info("Audit logging failed:", auditError);
        }
        return;
      }
      ...
      if (authResult.success) {
        ...
        try {
          ...
          logger.info("Audit logging failed, but login succeeded:", auditError);
        }
