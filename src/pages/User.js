...
class WarehouseManagementAPI {
  ...
  async connect() {
    logger.info("🔌 Connecting to Warehouse Management Sheets...");
    await new Promise((resolve) => setTimeout(resolve, 1500));
    this.isConnected = true;
    logger.info("✅ Connected to Warehouse Management Sheets");
  ...
  async syncWithHR(userId, hrData) {
    ...
    logger.info("🔄 Syncing with HR system for user:", userId);
